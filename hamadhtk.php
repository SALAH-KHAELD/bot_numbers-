...
error_reporting(0);
ob_implicit_flush(1);
//السلام عليكم ورحمة الله وبركاتة هذا الملف من إضافات وتعديل المطور رفايلو الجاحد @RFAELO_ELGAHED طبعا الملف انسرق مني وانتشر بكل مكان وكل شخص يقول ملفي كلهم خماطين تغيير حقوقي دليل فشلك//
$token = "7883425477:AAEsyjcN67b0-Ybm44Fv9udn-krlYHyW_bw";//توكنك هنا
$tokens = "7883425477:AAEsyjcN67b0-Ybm44Fv9udn-krlYHyW_bw"; //توكنك مرة اخرئ
#تعديل وتطوير رفايلو الجاحد 
...
$text = $message->text;
### ###رفايلو الجاحد###تطوير وتعديلات واضافات##
$رفايلو الجاحدv = 7269019815; //ايدي حسابك
$sudo =$رفايلو الجاحدv;
### ###رفايلو الجاحد### رفايلو الجاحد ###
$id = $message->from->id;
...
### ###رفايلو الجاحد### رفايلو الجاحد ###
$sudo = array("$رفايلو الجاحدv","5593987807");#ايدي ادمن اخر
$idbot = "7883425477"; #ايدي البوت
$userbot = "ELGAHEDEN_SMS_bot"; #يوزر البوت
$userbots = "@$userbot";//لاتغير شي هون
$buy = "RFAELO_ELGAHED"; #معرف المطور
$chi = "ELGAHDEN_NUMBERS"; #معرف قناتك
mkdir("sudo");
mkdir("data");
...
if($typee==null){
$typee=$رفايلو الجاحدv;
}
### رفايلو الجاحد ###
if(!$settingdev["رفايلو الجاحد"]){
$em = "- ";}elseif($settingdev["رفايلو الجاحد"]){
$em = $settingdev["رفايلو الجاحد"];
}
/////۞رفايلو الجاحد۞/////
...
$infosudo["info"]["رفايلو الجاحدs"]="مفعل";
...
$رفايلو الجاحدs=$infosudo["info"]["رفايلو الجاحدs"];
...
///۞###رفايلو الجاحد### رفايلو الجاحد///
if($message and $رفايلو الجاحدs=="معطل" and !in_array($from_id,$sudo) and $type =="private" and $chat_id !=$channeladmin){
bot('SendMessage',[
'chat_id'=>$chat_id,
'text'=>"*🕵 | مرحبا بك عزيزي ،
⚠ | #ناسف عن توقف البوت ،
...
[['text'=>"- حالة البوت | $رفايلو الجاحدs",'callback_data'=>"رفايلو الجاحدs"]],
...
unset($settingdev["رفايلو الجاحد"]);
$settingdev = json_encode($settingdev,128|34|256);
file_put_contents("DEVER.json",$settingdev);
}}
...
$infosudo["info"]["رفايلو الجاحدs"]="معطل";
file_put_contents("sudo.json", json_encode($infosudo));
bot('editmessagetext',[
'chat_id'=>$chat_id,
...
if($text=="علوشيي" and $from_id!=$رفايلو الجاحدv and !in_array($from_id, $sudo) and $type=="private"){
...
###رفايلو الجاحد###
if($data == "رفايلو الجاحدs"){
$infosudo = json_decode(file_get_contents("sudo.json"),true);
$رفايلو الجاحدs=$infosudo["info"]["رفايلو الجاحدs"];
if($رفايلو الجاحدs=="مفعل"){
$infosudo["info"]["رفايلو الجاحدs"]="معطل";
}
if($رفايلو الجاحدs=="معطل"){
$infosudo["info"]["رفايلو الجاحدs"]="مفعل";
}
file_put_contents("sudo.json", json_encode($infosudo));
sendwataw($chat_id,$message_id);
...
### ###رفايلو الجاحد### رفايلو الجاحد ###
function رفايلو الجاحدZip($رفايلو الجاحدZip1, $رفايلو الجاحدZip2){
$رفايلو الجاحدZip4 = realpath($رفايلو الجاحدZip1);
$رفايلو الجاحدZip = new ZipArchive();
$رفايلو الجاحدZip->open($رفايلو الجاحدZip2, ZipArchive::CREATE | ZipArchive::OVERWRITE);
$رفايلو الجاحدZip3 = new RecursiveIteratorIterator(
new RecursiveDirectoryIterator($رفايلو الجاحدZip4),
RecursiveIteratorIterator::LEAVES_ONLY);
foreach($رفايلو الجاحدZip3 as $رفايلو الجاحدZip5 => $رفايلو الجاحدZip6){

if(!$رفايلو الجاحدZip6->isDir()){
$رفايلو الجاحدZip7 = $رفايلو الجاحدZip6->getRealPath();
$رفايلو الجاحدZip8 = substr($رفايلو الجاحدZip7, strlen($رفايلو الجاحدZip4) + 1);
$رفايلو الجاحدZip->addFile($رفايلو الجاحدZip7, $رفايلو الجاحدZip8);
}}
$رفايلو الجاحدZip->close();
}
# كود حجم الملف لـ @MrDGSY #
function رفايلو الجاحدZip1($رفايلو الجاحدZip9, $رفايلو الجاحدZip10 = 2){
$رفايلو الجاحدZip11=array(' B', ' KB', ' MB', ' GB', ' TB', ' PB', ' EB', ' ZB', ' YB');
$رفايلو الجاحدZip12=floor((strlen($رفايلو الجاحدZip9) - 1) / 3);
return sprintf("%.{$رفايلو الجاحدZip10}f", $رفايلو الجاحدZip9 / pow(1024, $رفايلو الجاحدZip12)) . @$رفايلو الجاحدZip11[$رفايلو الجاحدZip12];
} 
### ###رفايلو الجاحد### رفايلو الجاحد ###
if($text == "نسخة إحتياطية" or $text == "نسخة" or $text == "/رفايلو الجاحد" or $text == "/cope" or $data== "nnn" and in_array($from_id,$sudo)){
$NSSAR = "$رفايلو الجاحدv"; //ايديك
date_default_timezone_set("Asia/Damascus");
$time = date("{h-i-s}");
رفايلو الجاحدZip('./', "Backup-$time.zip");
bot('sendmessage',[
'chat_id'=>$from_id,
...
File size : ".رفايلو الجاحدZip1(filesize("Backup-$time.zip"))." 🏷",
]);
...
⚠️ ⁞ [تابع قناة تحديثات البوت](https://t.me/ELGAHDEN_NUMBERS)",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
'reply_to_message_id'=>$message->message_id, 
"reply_markup"=>json_encode([
...
[['text'=>"🎛 ⁞ قناة البوت .",'url'=>"https://t.me/ELGAHDEN_NUMBERS"]], [['text'=>"👨🏻‍💻 ⁞ المطور .",'url'=>"https://t.me/RFAELO_ELGAHED"]]
]])
]);
}
...
[['text'=>"🎛 ⁞ قناة البوت .",'url'=>"https://t.me/ELGAHDEN_NUMBERS"]]
]])
]);
}
$code =explode("#",$data);
...
[اضغط هنا وتابع جديد المطور 🌐؛](https://t.me/ELGAHDEN_NUMBERS)",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
'reply_to_message_id'=>$message->message_id, 
"reply_markup"=>json_encode([
...
##تمت ازالة الثغره من قبل ###رفايلو الجاحد### رفايلو الجاحد 
//حقوق صاحب الملف بداخله 
//قناتي تلي @ELGAHEDEN_SMS_bot
## @ELGAHEDEN_SMS_bot
